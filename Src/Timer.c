...
* @retval-
******************************************************************************/
    TIM_HandleTypeDef TimHandle3,TimHandle4,TimHandle5;
	
    TIM_OC_InitTypeDef Tim3Pwm;
...
void Timer_init(void)
{
  ...
  */
    ...
    TimHandle3.Init.Period = 10000-1; //주기.
    TimHandle3.Init.Prescaler = uwPrescalerValue_Time3;
